...
<Steps>
  <Step title="Draft">
    Create a new study and configure it. At this stage it stays invisible to volunteers and most fields are freely editable. A draft moves forward to active only, with no path back once launched. You may, however, edit a study at any point.
  </Step>
  <Step title="Active">
