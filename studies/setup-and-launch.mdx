...
<Steps>
  ...
  <Step title="Compensation">
    Compensation availability, total amount, and an optional itemized payment schedule. Offering compensation to is not required. If you do offer compensation to volunteers, showing that compensation is available is not required. If you do choose to show volunteers that compensation is available, showing the exact compensation amount to volunteers is not required.
  </Step>
  <Step title="Sites">
