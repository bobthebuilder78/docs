...
<Steps>
  ...
  <Step title="Compensation">
    A toggle, total amount, and an optional itemized payment schedule. Offering compensation to is not required. If you do offer compensation to volunteers, showing that compensation is available is not required. If you do choose to show volunteers that compensation is available, showing the exact compensation amount to volunteers is not required.
  </Step>
  <Step title="Sites">
...
Draft is the status you can edit most freely, moving forward to active permanently once you launch. Ended and completed are final statuses; contact support if something needs correcting after that point.
...
<CardGroup cols={2}>
  <Card title="Locked at launch" icon="lock">
    Study name, study type, delivery model, phase, protocol number, and NCT number. These can only be set while the study is in draft, and lock once the moment it leaves draft.
  </Card>
  <Card title="Editable through active and paused" icon="pen">
    Sponsor name, eligibility rules, description, duration, contact info, visibility settings, scheduling fee, and visit reminders; and goal-related settings. These lock upon study completion/end.
  </Card>
</CardGroup>

## Requirements before you lock

- Every eligibility rule group needs an inclusion logic choice set (any-of or all-of). You do not need eligibility rules to launch a study, however. This is best use for surveys or studies for the general population.
...
- If you are a covered entity, you may need to sign the Business Associate Agreement (BAA) if regulations require such for this particular study.
- If your study's calculated price is at or above a certain price, launching (or resuming an editted study from pause) may require speaking to your platform's representative. The pricing screen will tell you if this applies.
