...
<Steps>
  ...
  <Step title="Compensation">
    Compensation availability, total amount, and an optional itemized payment schedule. Offering compensation is not required. If you do offer compensation to volunteers, showing that compensation is available is not required. If you do choose to show volunteers that compensation is available, showing the exact compensation amount is not required.
  </Step>
  <Step title="Sites">
...
<CardGroup cols={2}>
  ...
  <Card title="Editable through active and paused" icon="pen">
    Sponsor name, eligibility rules, description, duration, contact info, visibility settings, scheduling fee, visit reminders, and goal-related settings. These lock upon study completion or end.
  </Card>
</CardGroup>
