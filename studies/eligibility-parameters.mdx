...
Jaspari Studies lets you define who qualifies for your research using conditions, medications, and structured criteria, combined with a specific set of rules for how they interact. These rules follow a defined structure of their own.
...
<Steps>
  ...
  <Step title="Group when you need more than one at once">
    If you specifically need a volunteer on more than one item at the same time, both Drug A and Drug B for example, select those rules and choose "Group rules" then "Match ALL."
  </Step>
...
<Note>
  The rule builder shows a live summary sentence describing exactly what you've configured as you add and group rules. That sentence reflects the actual matching logic exactly, so trust it.
</Note>
